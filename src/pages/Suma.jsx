...
export default function Suma() {
    ...
    const generateNumbers = () => {
        ...
        let wrongAnswer1 = Math.floor(Math.random() * 71);
        let wrongAnswer2 = Math.floor(Math.random() * 71);

        while (wrongAnswer1 === correct) {
            wrongAnswer1 = Math.floor(Math.random() * 71);
        }
        while (wrongAnswer2 === correct || wrongAnswer2 === wrongAnswer1) {
            wrongAnswer2 = Math.floor(Math.random() * 71);
        }
